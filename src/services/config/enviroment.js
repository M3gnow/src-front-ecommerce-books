const config = (() => {
    return {
        ...
        VUE_APP_API_LESBOOK_CLIENT: 'https://run.mocky.io/v3/148a713d-d591-4850-8b3a-74d1d2b695ec',
        ...
        MOCK_APP_API_LESKBOOK_CARD_BY_ID: 'https://run.mocky.io/v3/d0ebae9c-035d-4e70-9c92-dfe2b2aeadf6',
